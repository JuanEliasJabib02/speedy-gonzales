import { ExternalLink, Zap, GitCommitHorizontal, RotateCcw, AlertTriangle, Code2 } from "lucide-react"
          ...
          {isStreaming && !hasContent ? (
            ...
            <>
              {isUser ? (
                ...
                <MarkdownContent content={message.content} components={chatMarkdownComponents} />
              )}
