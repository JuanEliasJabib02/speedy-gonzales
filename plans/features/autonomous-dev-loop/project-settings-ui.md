...
Add a settings panel to the project page where Juan can configure the autonomous loop: toggle it on/off, set the local path, and configure the Slack channel.
...
5. Text input for "Slack Channel" (e.g. #speedy-gonzales)
6. Save button
...
- [ ] Add text input for `slackChannel` with placeholder (e.g. `#speedy-gonzales`)
